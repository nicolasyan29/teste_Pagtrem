...
$trens = $pdo->query('SELECT * FROM trens ORDER BY id DESC')->fetchAll();
?>
    ...
    <div class="card">
      ...
      <table class="table"><thead><tr><th>ID</th><th>Código</th><th>Descrição</th><th>Capacidade</th><th>Status</th><th>Ações</th></tr></thead><tbody>
        ...
        <tr>
          ...
          <td><a class="action" href="editar_trem.php?id=<?php echo $t['id']; ?>">Editar</a> <a class="action danger" href="deletar_trem.php?id=<?php echo $t['id']; ?>" onclick="return confirm('Confirmar?')">Deletar</a></td>
        </tr>
        <?php endforeach; ?>
      </tbody></table>
    </div>
