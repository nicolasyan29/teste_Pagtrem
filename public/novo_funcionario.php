...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        mysqli_stmt_bind_param($stmt, "sssssssssss",$nome,$cpf,$cargo,$email,$telefone,$cep,$rua,$bairro,$cidade,$estado,$local);
        mysqli_stmt_execute($stmt);
        header('Location: funcionarios.php'); exit;
    }
}
?>
<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Novo Funcionário</title><link rel="stylesheet" href="../assets/style.css"></head><body>
  <div class="app-shell">
